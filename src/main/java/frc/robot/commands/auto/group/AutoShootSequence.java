...
public class AutoShootSequence extends SequentialCommandGroup {
  ...
  public AutoShootSequence(IntakeShooterSubsystem intakeShooter, ArmSubsystem arm) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new ArmToAngle(Constants.Setpoints.HOME.angleDegrees, arm),
      new AutoShooterOn(intakeShooter, 1, 0.7)
    );
  }
}
